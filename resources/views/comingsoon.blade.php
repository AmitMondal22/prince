    ...
    <body>
        ...
        <div id="middle">
            ...
            <h3>
                <i
                    ...
                    style="margin-right: 0.15em; margin-left: 0"
                ></i
                >2023 | WrongCode.<a href="">in<i
                        class="fas fa-heart"
                        style="margin-left: 0.2em; margin-right: 0; color: red"
                    ></i>
                </a>
            </h3>
        ...
        <script>
            ...
            var countdownfunction = setInterval(function () {
                ...
                document.getElementById("c_days").innerHTML =
                    days + "<br> Days";
                document.getElementById("c_hours").innerHTML =
                    hours + "<br> Hours";
                document.getElementById("c_minutes").innerHTML =
                    minutes + "<br> Minutes";
                document.getElementById("c_seconds").innerHTML =
                    seconds + "<br> Seconds";
